            ...
            <div className="text-editor-controls">
                <div className="left-side">
                    <span className="option">
                        { [this.inlineStyles, this.alignments, this.lists, this.link].map((section, index) => {
                            return (
                                <span className="buttons-section" key={ index }>
                                    { section.map((elem) => (
                                        <StyleButton
                                            key={ elem.icon }
                                            icon={ elem.icon }
                    ...
                    { this.props.disableAttachments ? '' :
                        ...
                        { this.props.disabledUpload ? '' :
                            ...
                            <SVG size="18" className={ 'option-icon attachment' + (this.props.disabledUpload ? ' disabled' : '') } icon={ 'attachment' }/>
                    </span>
                    }
                    <span className="option" onClick={ this.toggleFaces }>
                        ...
                        <SVG className="option-icon" size="18" icon={ 'happy' }/>
                    </span>
                    <span className="option">
                        <Variables show={ this.state.variablesOpen } onSelect={ this.insertVariable } style={{ bottom: 0 }}/>
                        <span onClick={ this.toggleVariables }><SVG size="18" className="option-icon" icon={ 'addCircle' }/></span>
                    </span>
                </div>
                { this.props.disableSubmit ? '' :
                    <div className="right-side">
                        {/*<span className="option">*/}
                            ...
                            {/*<span onClick={ this.toggleTemplates }><SVG size="18" className="option-icon" icon={ 'file' }/></span>*/}
                        {/*</span>*/}
                        {/*<span className="option" onClick={ this.props.toggleFullScreen }>*/}
                            {/*<SVG size="18" className="option-icon" icon={ 'fullscreen' }/>*/}
                        {/*</span>*/}
